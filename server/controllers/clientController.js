...
const updateClient = async (req, res) => {
    ...
    try {
        const result = await pool.query(
            'UPDATE clients SET name = $1 , company_name = $2 , email = $3 , phone=$4 ,address=$5 ,city=$6 ,country=$7, website=$8 , industry=$9 ,tax_id=$10 , payment_terms=$11 ,hourly_rate=$12 , currency=$13 , status =$14 ,client_type=$15, notes=$16 ,updated_at = NOW() WHERE id =$17  RETURNING * ',
            [
                name, company_name, email, phone, address, city, country, website, industry, tax_id, payment_terms, hourly_rate, currency, status, client_type, notes, id
            ]
